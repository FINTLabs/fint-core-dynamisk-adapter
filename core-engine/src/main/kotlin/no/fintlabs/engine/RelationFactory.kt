...
import no.fintlabs.contract.util.putLink
                ...
                if (edgeToSkip in skip) {
                    ...
                    when (relation.multiplicity) {
                        ...
                        FintMultiplicity.ONE_TO_MANY -> {
                            val secondaryMetadata = getSecondaryMetadata(relation, resource.key, metadataList)
...
//            val fault = rollRelationFault()
            ...
            val targetToApply = correctTarget
//                when (fault) {
...
//            }
    ...
    private fun getSecondaryMetadata(
        relation: FintRelation,
        primaryKey: String,
        metaList: MutableList<ExpandedMetadata>
    ): ExpandedMetadata? {
        ...
        return metaList.find { it.key == key }
    }
